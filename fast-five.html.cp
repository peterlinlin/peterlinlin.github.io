...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <!-- Navigation -->
    <nav class="navbar navbar-expand-sm navbar-dark fixed-top" style = "background: black" id="mainNav">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto nav-justified">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#trivia">Trivia</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <!-- Intro Header -->
    <header class="masthead fast-five">
      <div class="intro-body">
        <div class="container">
          <div class="row">
              <div class="col-lg-8 mx-auto title-background">
                <h1 class="brand-heading">Fast Five</h1>
                <p class="intro-text">A multi-award winning franchise
                <br>starring the late Paul Walker, Vin Diesel and Gal Gadot</p>
                <a href="#summary" class="btn btn-circle js-scroll-trigger">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto">
            <h2><b>Summary</b></h2>
            <p>Former cop Brian O'Conner (<a href="https://en.wikipedia.org/wiki/Paul_Walker">Paul Walker</a>) partners with ex-con Dominic Toretto (<a href="https://en.wikipedia.org/wiki/Vin_Diesel">Vin Diesel</a>) on
    ...
    <!-- Awards Section -->
    <section id="awards" class="content-section text-center">
      <div class="container">
        <div class="col-lg-8 mx-auto">
          <h2>Awards</h2>
          <table class="wikitable" style="width:100%;">
            ...
            <td color: black; vertical-align: middle; text-align: center;" class="yes table-yes2">Won</td>
            ...
            <td color: black; vertical-align: middle; text-align: center;" class="no table-no2">Nominated</td>

            </tr>
            <tr>
            <td>Best Summer 2011 Blockbuster Poster</td>
            <td>"<i>Fast Five</i>"&nbsp;– Universal Pictures, Cold Open</td>
            <td color: black; vertical-align: middle; text-align: center;" class="no table-no2">Nominated</td>
            </tr>
            <tr>
            <td>Best Summer Blockbuster 2011 TV Spot</td>
            <td>"<i>Super Bowl</i>"&nbsp;– Universal Pictures, AV Squad</td>
            <td color: black; vertical-align: middle; text-align: center;" class="yes table-yes2">Won</td>
            </tr>
            <tr>
            ...
            <tr>
            <td>Best Editing</td>
            <td>Kelly Matsumoto, Fred Raskin, and Christian Watner</td>
            <td color: black; vertical-align: middle; text-align: center;" class="no table-no2">Nominated</td>
            </tr>
            </tbody>
          </table>
    ...
    <!-- Trivia Section -->
    <section id="trivia" class="content-section text-center">
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto">
            <h2>Trivia</h2>
              <p><a href="https://en.wikipedia.org/wiki/Gal_Gadot">Gal Gadot's</a> character name (Gisele) is never mentioned in the entire film.</p>
              <p>Released on the tenth anniversary of The Fast & The Furious (2001).</p>
              <p><a href="https://en.wikipedia.org/wiki/Vin_Diesel">Vin Diesel</a> and <a href="https://en.wikipedia.org/wiki/Elsa_Pataky">Elsa Pataky</a> share a birthday. However, Diesel is 9 years older.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="container">
      <div class="row-fluid">
        <div class="span4 offset4 text-center">
          <h2>Other Movies in the franchise</h2>
          <a href="the-fast-and-the-furious.html" button type="button" class="btn-default-change-page" role="button">1</a>
          <a href="2-fast-2-furious.html" button type="button" class="btn-default-change-page" role="button">2</a>
          <a href="tokyo-drift.html" button type="button" class="btn-default-change-page" role="button">3</a>
          <a href="fast-&-furious.html" button type="button" class="btn-default-change-page" role="button">4</a>
          <a href="fast-five.html" button type="button" class="btn-default-change-page" role="button">5</a>
          <a href="fast-&-furious-6.html" button type="button" class="btn-default-change-page" role="button">6</a>
          <a href="furious-7.html" button type="button" class="btn-default-change-page" role="button">7</a>
          <a href="the-fate-of-the-furious.html" button type="button" class="btn-default-change-page" role="button">8</a>
        </div>
      </div>
    </section>
    ...
    <footer>
      <div class="container text-center">
        <p>Copyright &copy; Peter Lin 2018</p>
      </div>
    </footer>
