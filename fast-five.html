          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              ...
              <p class="intro-text">A multi award winning franchise
                <br>starring the late Paul Walker and Vin Diesel</p>
    ...
    <section class="container">
      <div class="row-fluid">
        <div class="span4 offset4 text-center">
          ...
          <a href="the-fast-and-the-furious.html" button type="button" class="btn-default-change-page" role="button">2</a>
          <a href="the-fast-and-the-furious.html" button type="button" class="btn-default-change-page" role="button">3</a>
          <a href="the-fast-and-the-furious.html" button type="button" class="btn-default-change-page" role="button">4</a>
          <a href="the-fast-and-the-furious.html" button type="button" class="btn-default-change-page" role="button">5</a>
          <a href="the-fast-and-the-furious.html" button type="button" class="btn-default-change-page" role="button">6</a>
          <a href="the-fast-and-the-furious.html" button type="button" class="btn-default-change-page" role="button">7</a>
          <a href="the-fast-and-the-furious.html" button type="button" class="btn-default-change-page" role="button">8</a>
        </div>
      </div>
    </section>
...
<!--
    <sectionclass="content-section text-center">
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto">
            <h2>Other Movies in the franchise</h2>
            <ul class="list-inline banner-social-buttons">
              <li class="list-inline-item">
                <a href="the-fast-and-the-furious.html" class="btn btn-default btn-lg">
                  <p>1</p>
                </a>
              </li>
              <li class="list-inline-item">
                <a href="2-fast-2-furious.html" class="btn btn-default btn-lg">
                  <p>2</p>
                </a>
              </li>
              <li class="list-inline-item">
                <a href="tokyo-drift.html" class="btn btn-default btn-lg">
                  <p>3</p>
                </a>
              </li>
              <li class="list-inline-item">
                <a href="fast-&-furious.html" class="btn btn-default btn-lg">
                  <p>4</p>
                </a>
              </li>
              <li class="list-inline-item">
                <a href="fast-&-furious-6.html" class="btn btn-default btn-lg">
                  <p>6</p>
                </a>
              </li>
              <li class="list-inline-item">
                <a href="furious-7" class="btn btn-default btn-lg">
                  <p>7</p>
                </a>
              </li>
              <li class="list-inline-item">
                <a href="the-fate-of-the-furious" class="btn btn-default btn-lg">
                  <p>8</p>
                </a>
              </li>
            </ul>
